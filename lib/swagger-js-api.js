...
var swaggerAPI = (function () {
    ...
    */
    ...
    function swaggerAPI(defaultUserOptions){
      ...
      var defaultCallOptions = {
          "hostname": 'http://alpha.calendar42.com',
          "endpoint": ""
      };
      ...
      this.registerSpec = function(resp /* ,status */){
        ...
        getAPISSpec.bind(self)(_constructAPI.bind(this));
      };

      getSpecOptions.callback = this.registerSpec;
    ...
    */
    ...
    var getAPISSpec = function(){
      ...
      // used as a counters. Y will be used to count the callbacksm and call the callbackMedhot only when all calls are being answered
      var i, y = 0;
    ...
    _constructAPI = function (APIEndpoints){
      ...
      var operation;
      var restAPIPoint;
      for (var i = 0; i < this.restAPIPoints.length; i++) {
        restAPIPoint = this.restAPIPoints[i];
        for (var i = 0; i < restAPIPoint.operations.length; i++) {
          operation = restAPIPoint.operations[i];
          this.prototype[operation.nikname] = function(){
            // @TODO perform the action based on the method.
          }
        }
        // var enpointName = restAPIPoint.

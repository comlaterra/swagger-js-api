...
var swaggerAPI = (function () {
    ...
    function swaggerAPI(defaultUserOptions){
      ...
      this.defaultCallOptions = {
          ...
          "basePath": (defaultUserOptions.serverInfo.basePath)?defaultUserOptions.serverInfo.basePath:'http://example.api'
      };
      this.configOptions = utils.deepExtend(defaultConfigOPtions, defaultUserOptions);
      // Validate of the required config params
      if(!this.configOptions.serverInfo && !this.configOptions.serverInfo.basePath){
